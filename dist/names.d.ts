 ...
 */
declare function nameAlu(n: string, s: string, nm: NounMode, am: AdjectiveMode, dialect: Dialect, init?: RequestInit): Promise<string>;
/**
 ...
 * @returns {Promise<string>}
 */
declare function nameFull(ending: NameEnding, n: string, s1: string, s2: string, s3: string, dialect: Dialect, init?: RequestInit): Promise<string>;
/**
 ...
 * @returns {Promise<string>}
 */
declare function nameFullWithLimit(ending: NameEnding, n: string, s1: string, s2: string, s3: string, dialect: Dialect, init?: RequestInit): Promise<string>;
/**
 ...
 * @returns {Promise<string>}
 */
declare function nameSingle(n: string, s: string, dialect: Dialect, init?: RequestInit): Promise<string>;
